...
public interface SAML2Constants {
	 ...
	 */
	public String ASSERTION_DECLARE_STR = " xmlns:saml=\"urn:oasis:names:tc:SAML:2.0:assertion\"";

	/**
	 * SAMLv2 assertion namespace URI.
	 */
	public String ASSERTION_NAMESPACE_URI = "urn:oasis:names:tc:SAML:2.0:assertion";

	/**
	 * Default namespace attribute for <code>Action</code>.
	 */
	public String ACTION_NAMESPACE_NEGATION = "urn:oasis:names:tc:SAML:1.0:action:rwedc-negation";
	 ...
	 * String used to declare SAMLv2 protocol namespace.
	 */
	public String PROTOCOL_DECLARE_STR = " xmlns:samlp=\"urn:oasis:names:tc:SAML:2.0:protocol\"";

	/**
	 * String used to represent HTTP Redirect Binding.
	 */
	public String HTTP_REDIRECT = "urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect";

	/**
	 * String used to represent SOAP Binding.
	 */
	public String SOAP = "urn:oasis:names:tc:SAML:2.0:bindings:SOAP";
	 ...
	 */
	public String HTTP_POST = "urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST";

	/**
	 * String used to represent HTTP ARTIFACT Binding.
	 */
	public String HTTP_ARTIFACT = "urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Artifact";

	/**
	 * String used to represent URI Binding.
	 */
	public String URI = "urn:oasis:names:tc:SAML:2.0:bindings:URI";

	/**
	 * String to represent Name Identifier Format name space
	 */
	public String NAMEID_FORMAT_NAMESPACE = "urn:oasis:names:tc:SAML:2.0:nameid-format:";
	 ...
	 */
	public String ENCRYPTED = NAMEID_FORMAT_NAMESPACE + "encrypted";

	/**
	 * String to represent Persitent Name Identifier
	 */
	public String PERSISTENT = NAMEID_FORMAT_NAMESPACE + "persistent";

	/**
	 * String to represent Unspecified Name Identifier
	 */
	public String UNSPECIFIED = NAMEID_FORMAT_NAMESPACE_V_1_1 + "unspecified";

	/**
	 * String to represent Email Address Name Identifier
	 */
	public String EMAIL_ADDRESS = NAMEID_FORMAT_NAMESPACE_V_1_1 + "emailAddress";

	/**
	 * String to represent Entity Name Identifier
	 */
	public String ENTITY = NAMEID_FORMAT_NAMESPACE + "entity";

	/**
	 * String to represent X509 Subejct Name Identifier
	 */
	public String X509_SUBJECT_NAME = NAMEID_FORMAT_NAMESPACE_V_1_1 + "X509SubjectName";

	/**
	 * String to represent Windows Domain Qualified Name Identifier
	 */
	public String WINDOWS_DOMAIN_QUALIFIED_NAME = NAMEID_FORMAT_NAMESPACE_V_1_1 + "WindowsDomainQualifiedName";

	/**
	 * String to represent Kerberos Principal Name Identifier
	 */
	public String KERBEROS_PRINCIPAL_NAME = NAMEID_FORMAT_NAMESPACE + "kerberos";
	 ...
	 */
	public String SUCCESS = "urn:oasis:names:tc:SAML:2.0:status:Success";

	public String REQUESTER = "urn:oasis:names:tc:SAML:2.0:status:Requester";

	public String RESPONDER = "urn:oasis:names:tc:SAML:2.0:status:Responder";

	public String NOPASSIVE = "urn:oasis:names:tc:SAML:2.0:status:NoPassive";

	public String VERSION_MISMATCH = "urn:oasis:names:tc:SAML:2.0:status:VersionMismatch";

	public String UNKNOWN_PRINCIPAL = "urn:oasis:names:tc:SAML:2.0:status:UnknownPrincipal";

	public String AUTHN_FAILED = "urn:oasis:names:tc:SAML:2.0:status:AuthnFailed";

	public String INVALID_ATTR_NAME_OR_VALUE = "urn:oasis:names:tc:SAML:2.0:status:InvalidAttrNameOrValue";

	public String INVALID_NAME_ID_POLICY = "urn:oasis:names:tc:SAML:2.0:status:InvalidNameIDPolicy";

	public String NO_AUTHN_CONTEXT = "urn:oasis:names:tc:SAML:2.0:status:NoAuthnContext";

	/**
	 * Basic name format
	 */
	public String BASIC_NAME_FORMAT = "urn:oasis:names:tc:SAML:2.0:attrname-format:basic";

	/**
	 * Basic attribute profile
	 */
	public String BASIC_ATTRIBUTE_PROFILE = "urn:oasis:names:tc:SAML:2.0:profiles:attribute:basic";
	 ...
	 */
	public String SUBJECT_CONFIRMATION_METHOD_BEARER = "urn:oasis:names:tc:SAML:2.0:cm:bearer";

	/**
	 * Confirmation method for holder of key
	 */
	public String SUBJECT_CONFIRMATION_METHOD_HOLDER_OF_KEY = "urn:oasis:names:tc:SAML:2.0:cm:holder-of-key";

	/**
	 * Confirmation method for sender vouches
	 */
	public String SUBJECT_CONFIRMATION_METHOD_SENDER_VOUCHES = "urn:oasis:names:tc:SAML:2.0:cm:sender-vouches";
	 ...
	 */
	public String BINDING_PREFIX = "urn:oasis:names:tc:SAML:2.0:bindings:";

	/**
	 * Constant for AssertionConsumerServiceIndex attribute
	 */
	public String ASSERTION_CONSUMER_SVC_INDEX = "AssertionConsumerServiceIndex";
	/**
	 * Constant for AssertionConsumerServiceURL attribute
	 */
	public String ASSERTION_CONSUMER_SVC_URL = "AssertionConsumerServiceURL";
	/**
	 * Constant for AttributeConsumingServiceIndex attribute
	 */
	public String ATTR_CONSUMING_SVC_INDEX = "AttributeConsumingServiceIndex";
	/**
	...
	public String CLEANUP_INTERVAL_NAME = "iplanet-am-saml-cleanup-interval";
	 ...
	 */
	public String AUTO_FED_ATTRIBUTE = "autofedAttribute";

	/**
	 * Auto federation enable attribute.
	 */
	public String AUTO_FED_ENABLED = "autofedEnabled";

	/**
	 * Transient federation users.
	 */
	public String TRANSIENT_FED_USER = "transientUser";

	public String NAMEID_TRANSIENT_FORMAT = NAMEID_FORMAT_NAMESPACE + "transient";
	 ...
	 * implementation class. Those variables will be passed down as Map to the
	 * implementation class for initialization.
	 */
	...
	/**
	 * Environment (attribute/value pair) for fedlet adapter implementation
	 * class. Those variables will be passed down as Map to the implementation
	 ...
	 */
	public String SP_ACCOUNT_MAPPER = "spAccountMapper";
	 ...
	 */
	public String SP_ATTRIBUTE_MAPPER = "spAttributeMapper";

	/**
	 * Identity provider account mapper.
	 */
	public String IDP_ACCOUNT_MAPPER = "idpAccountMapper";

	/**
	 * Identity provider attribute mapper.
	 */
	public String IDP_ATTRIBUTE_MAPPER = "idpAttributeMapper";

	/**
	 * Attribute authority mapper.
	 */
	public String ATTRIBUTE_AUTHORITY_MAPPER = "attributeAuthorityMapper";

	/**
	 * Assertion ID request mapper.
	 */
	public String ASSERTION_ID_REQUEST_MAPPER = "assertionIDRequestMapper";
	...
	public String AUTH_CONTEXT_DECL_REF_ATTR = "sunFMAuthContextDeclareRef";

	public String AUTH_CONTEXT_CLASS_REF = "AuthnContextClassRef";

	public String AUTH_CONTEXT_CLASS_REF_ATTR = "sunFMAuthContextClassRef";
	...
	/**
	 * Attribute to be configured in SPSSOConfig for SAML2 authentication module
	 * instance name.
	 */
	...
	/**
	 * This is an attribute in entity config for the encryption certificate
	 * alias
	 */
	...
	public String SIG_PROVIDER = "com.sun.identity.saml2.xmlsig.SignatureProvider";

	public String ENC_PROVIDER = "com.sun.identity.saml2.xmlenc.EncryptionProvider";
	...
	/**
	 * Http request parameter used to indicate whether the intent is federation
	 * or not. Its values are "true" and "false".
	 */
	public String FEDERATE = "federate";

	/** xmlsig signing parameters */
	public String CANONICALIZATION_METHOD = "com.sun.identity.saml.xmlsig.c14nMethod";
	public String TRANSFORM_ALGORITHM = "com.sun.identity.saml.xmlsig.transformAlg";
	public String XMLSIG_ALGORITHM = "com.sun.identity.saml.xmlsig.xmlSigAlgorithm";
	...
	public String WANT_ATTRIBUTE_ENCRYPTED = "wantAttributeEncrypted";
	 ...
	 */
	public String WANT_ARTIFACT_RESPONSE_SIGNED = "wantArtifactResponseSigned";
	public String WANT_LOGOUT_REQUEST_SIGNED = "wantLogoutRequestSigned";
	public String WANT_LOGOUT_RESPONSE_SIGNED = "wantLogoutResponseSigned";
	public String WANT_MNI_REQUEST_SIGNED = "wantMNIRequestSigned";
	public String WANT_MNI_RESPONSE_SIGNED = "wantMNIResponseSigned";
	public String WANT_POST_RESPONSE_SIGNED = "wantPOSTResponseSigned";

	/**
	 * SP Entity Config attribute name. Used to specify IDPList child element of
	 * ECP request.
	 */
	 ...
	 */
	public String X509_SUBJECT_DATA_STORE_ATTR_NAME = "x509SubjectDataStoreAttrName";
	 ...
	 */
	public String SP_AUTHCONTEXT_MAPPER = "spAuthncontextMapper";

	/**
	 * Default value for Service provider AuthnContext mapper value.
	 */
	public String DEFAULT_SP_AUTHCONTEXT_MAPPER = "com.sun.identity.saml2.plugins.DefaultSPAuthnContextMapper";

	/**
	 * Service provider AuthnContext Class Reference and AuthLevel Mapping.
	 */
	public String SP_AUTH_CONTEXT_CLASS_REF_ATTR = "spAuthncontextClassrefMapping";

	/**
	 * Constant for AuthnContext Class Reference namespace
	 */
	public String AUTH_CTX_PREFIX = "urn:oasis:names:tc:SAML:2.0:ac:classes:";

	/**
	 * Default Service provider AuthnContext Class Reference and AuthLevel
	 * Mapping value.
	 */
	public String SP_AUTHCONTEXT_CLASSREF_VALUE = "urn:oasis:names:tc:SAML:2.0:ac:classes:PasswordProtectedTransport|0|default";
	/**
	 * Service provider AuthnContext Comparison Type attribute name.
	 */
	public String SP_AUTHCONTEXT_COMPARISON_TYPE = "spAuthncontextComparisonType";
	...
	public String SDK_CLASS_MAPPING = "com.sun.identity.saml2.sdk.mapping.";
	...
	public String ASSERTION_EFFECTIVE_TIME_ATTRIBUTE = "assertionEffectiveTime";

	// NotBefore Assertion skew attribute name
	public String ASSERTION_NOTBEFORE_SKEW_ATTRIBUTE = "assertionNotBeforeTimeSkew";

	// IDP authn context mapper class attribute name
	public String IDP_AUTHNCONTEXT_MAPPER_CLASS = "idpAuthncontextMapper";
	...
	public String DEFAULT_IDP_AUTHNCONTEXT_MAPPER_CLASS = "com.sun.identity.saml2.plugins.DefaultIDPAuthnContextMapper";

	// Default IDP account mapper class name
	public String DEFAULT_IDP_ACCOUNT_MAPPER_CLASS = "com.sun.identity.saml2.plugins.DefaultIDPAccountMapper";

	// Default SP account mapper class name
	public String DEFAULT_SP_ACCOUNT_MAPPER_CLASS = "com.sun.identity.saml2.plugins.DefaultSPAccountMapper";

	// Default IDP attribute mapper class name
	public String DEFAULT_IDP_ATTRIBUTE_MAPPER_CLASS = "com.sun.identity.saml2.plugins.DefaultIDPAttributeMapper";
	...
	public String IDP_AUTHNCONTEXT_CLASSREF_MAPPING = "idpAuthncontextClassrefMapping";

	// AuthnContext Class Reference names
	public String CLASSREF_PASSWORD_PROTECTED_TRANSPORT = "urn:oasis:names:tc:SAML:2.0:ac:classes:PasswordProtectedTransport";
	...
	// value in seconds
	public String CACHE_CLEANUP_INTERVAL = "com.sun.identity.saml2.cacheCleanUpInterval";
	 ...
	 */
	String WANT_XACML_AUTHZ_DECISION_QUERY_SIGNED = "wantXACMLAuthzDecisionQuerySigned";

	/**
	 * Want Authorization Decision Response Signed.
	 */
	String WANT_XACML_AUTHZ_DECISION_RESPONSED_SIGNED = "wantXACMLAuthzDecisionResponseSigned";

	/**
	 * Generate Discovery Bootstrapping
	 */
	public String DISCO_BOOTSTRAPPING_ENABLED = "discoveryBootstrappingEnabled";

	/**
	 * Constant for Response Artifact message encoding property
	 */
	public String RESPONSE_ARTIFACT_MESSAGE_ENCODING = "responseArtifactMessageEncoding";
	 ...
	 * Cache Assertion
	 */
	public String ASSERTION_CACHE_ENABLED = "assertionCacheEnabled";

	/**
	 * Attribute name format for ID-WSF 1.1 Discovery bootstrap
	 */
	public String DISCOVERY_BOOTSTRAP_ATTRIBUTE_NAME_FORMAT = "urn:oasis:names:tc:SAML:2.0:attrname-format:uri";

	/**
	 * Attribute name for ID-WSF 1.1 Discovery bootstrap
	 */
	public String DISCOVERY_BOOTSTRAP_ATTRIBUTE_NAME = "urn:liberty:disco:2003-08:DiscoveryResourceOffering";

	/**
	 * Constant for Discovery bootstrap credentials SSO token property
	 */
	public String DISCOVERY_BOOTSTRAP_CREDENTIALS = "DiscoveryBootstrapCrendentials";
	 ...
	 */
	public String XSI_DECLARE_STR = "xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"";
	 ...
	 */
	public String IDP_PROXY_FINDER_NAME = "com.sun.identity.saml2.idpproxy";

	/**
	 * Default class name of IDP Proxy finder
	 */
	public String DEFAULT_IDP_PROXY_FINDER = "com.sun.identity.saml2.plugins.SAML2IDPProxyImpl";
	...
	/**
	 * IDP Proxy finder implmentation classe attribute name in the IDP Extended
	 * metadata
	 */
	public static final String PROXY_IDP_FINDER_CLASS = "proxyIDPFinderClass";

	/**
	 * Flag to indicate if the IdP must enable the IdP Finder This is the name
	 * of the attribute flag in the IDP Extended metadata
	 */
	public static final String ENABLE_PROXY_IDP_FINDER_FOR_ALL_SPS = "enableProxyIDPFinderForAllSPs";

	/**
	 * Attribute Name in the extended metadata that takes the value of the JSP
	 * that will present the list of IdPs to the user
	 */
	...
	/**
	 * Wild card to indicate mapping any attribute name as it is in the
	 * Assertion
	 */
	...
	/**
	 * String to represent the logout url for external application. SAML2
	 * component will send request to the external logout URL using back channel
	 * HTTP POST mechanism. This is used when the single logout is initiated
	 * from remote party (SP or IDP).
	 */
	public String APP_LOGOUT_URL = "appLogoutUrl";

	/**
	 * URL parameter name in external application logout URL for requesting user
	 * session property. Value is a session property name whose value will be
	 * posted to application as http header and content for its logout use.
	 */
	 ...
	 */
	public String IDP_SESSION_SYNC_ENABLED = "idpSessionSyncEnabled";

	/**
	 * SP Session Synchronize Enabled
	 */
	public String SP_SESSION_SYNC_ENABLED = "spSessionSyncEnabled";
	...
	/**
	 * Flag to Indicate that we do not want to write the Federation info in the
	 * SP local User Data Store. This flag is set in the local SP extended
