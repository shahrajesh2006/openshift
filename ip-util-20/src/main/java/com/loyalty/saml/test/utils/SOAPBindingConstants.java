...
public final class SOAPBindingConstants {
	 ...
	 */
	public static final String TAG_SERVICE_INSTANCE_UPDATE = "ServiceInstanceUpdate";
	 ...
	 */
	public static final String PTAG_SERVICE_INSTANCE_UPDATE = "sb-ext:ServiceInstanceUpdate";
